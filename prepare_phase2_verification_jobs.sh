...
JOB_NAME_PREFIX="phase2_verification_batch"
TEMPLATE_JOB_NAME="phase1_verification_template"
PROMPT_MACHINE_NAME="match_verification_unqualified_with_marcxml_prompt_machine"
...
for i in $(seq $START $END); do
    ...
    python3 prepare_job.py --job_name "$CURRENT_NAME" --from "$TEMPLATE_JOB_NAME" --prompt_machine "$PROMPT_MACHINE_NAME" --source_batch_job_directory "$SOURCE_BATCH_JOB_PREFIX${i}"
